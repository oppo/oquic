...
static ERR_STRING_DATA QAT_str_functs[] = {
    {ERR_PACK(0, QAT_F_AES_GCM_TLS_CIPHER, 0), "aes_gcm_tls_cipher"},
    ...
    {ERR_PACK(0, QAT_F_MB_ECDH_COMPUTE_KEY, 0), "mb_ecdh_compute_key"},
    {ERR_PACK(0, QAT_F_MB_ECDH_GENERATE_KEY, 0), "mb_ecdh_generate_key"},
    {ERR_PACK(0, QAT_F_MB_ECDSA_SIGN, 0), "mb_ecdsa_sign"},
    {ERR_PACK(0, QAT_F_MB_ECDSA_SIGN_SETUP, 0), "mb_ecdsa_sign_setup"},
    {ERR_PACK(0, QAT_F_MB_ECDSA_SIGN_SIG, 0), "mb_ecdsa_sign_sig"},
    {ERR_PACK(0, QAT_F_MB_FREE_EC_METHODS, 0), "mb_free_EC_methods"},
    {ERR_PACK(0, QAT_F_MB_GET_EC_METHODS, 0), "mb_get_EC_methods"},
    {ERR_PACK(0, QAT_F_MULTIBUFF_FINISH_INT, 0), "multibuff_finish_int"},
    {ERR_PACK(0, QAT_F_MULTIBUFF_FREE_RSA_METHODS, 0),
    ...
    {ERR_PACK(0, QAT_F_MULTIBUFF_RSA_ADD_PADDING_PRIV_ENC, 0),
     "multibuff_rsa_add_padding_priv_enc"},
    {ERR_PACK(0, QAT_F_MULTIBUFF_RSA_ADD_PADDING_PUB_ENC, 0),
     "multibuff_rsa_add_padding_pub_enc"},
    {ERR_PACK(0, QAT_F_MULTIBUFF_RSA_PRIV_DEC, 0), "multibuff_rsa_priv_dec"},
    {ERR_PACK(0, QAT_F_MULTIBUFF_RSA_PRIV_ENC, 0), "multibuff_rsa_priv_enc"},
    {ERR_PACK(0, QAT_F_MULTIBUFF_RSA_PUB_DEC, 0), "multibuff_rsa_pub_dec"},
    {ERR_PACK(0, QAT_F_MULTIBUFF_RSA_PUB_ENC, 0), "multibuff_rsa_pub_enc"},
    {ERR_PACK(0, QAT_F_MULTIBUFF_VALIDATE_ECX_DERIVE, 0),
    ...
    {ERR_PACK(0, QAT_F_QAT_AES_GCM_CIPHER, 0), "qat_aes_gcm_cipher"},
    {ERR_PACK(0, QAT_F_QAT_AES_GCM_CLEANUP, 0), "qat_aes_gcm_cleanup"},
    {ERR_PACK(0, QAT_F_QAT_AES_GCM_CTRL, 0), "qat_aes_gcm_ctrl"},
    {ERR_PACK(0, QAT_F_QAT_AES_GCM_INIT, 0), "qat_aes_gcm_init"},
    ...
    {ERR_PACK(0, QAT_F_QAT_FINISH_INT, 0), "qat_finish_int"},
    ...
    {ERR_PACK(0, QAT_F_QAT_INIT, 0), "qat_init"},
    ...
    {ERR_PACK(0, QAT_F_QAT_PKEY_ECX_DERIVE25519, 0),
     "qat_pkey_ecx_derive25519"},
    {ERR_PACK(0, QAT_F_QAT_PKEY_ECX_DERIVE448, 0), "qat_pkey_ecx_derive448"},
    {ERR_PACK(0, QAT_F_QAT_PKEY_ECX_KEYGEN, 0), "qat_pkey_ecx_keygen"},
    ...
    {ERR_PACK(0, QAT_F_QAT_X448_PMETH, 0), "qat_x448_pmeth"},
    {ERR_PACK(0, QAT_F_VAESGCM_CIPHERS_CTRL, 0), "vaesgcm_ciphers_ctrl"},
    {ERR_PACK(0, QAT_F_VAESGCM_CIPHERS_DO_CIPHER, 0),
     "vaesgcm_ciphers_do_cipher"},
    {ERR_PACK(0, QAT_F_VAESGCM_CIPHERS_INIT, 0), "vaesgcm_ciphers_init"},
    {ERR_PACK(0, QAT_F_VAESGCM_CREATE_CIPHER_METH, 0),
     "vaesgcm_create_cipher_meth"},
    {ERR_PACK(0, QAT_F_VAESGCM_INIT_GCM, 0), "vaesgcm_init_gcm"},
    {ERR_PACK(0, QAT_F_VAESGCM_INIT_IPSEC_MB_MGR, 0),
     "vaesgcm_init_ipsec_mb_mgr"},
    {ERR_PACK(0, QAT_F_VAESGCM_INIT_KEY, 0), "vaesgcm_init_key"},
    {0, NULL}
};
